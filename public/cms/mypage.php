                        ...
                        <div class="container">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="flex-row-fluid ml-lg-8">
                                    ...
                                    <!--end::Card-->
                                    <!-- begin::버튼 그룹 -->
                                    <div class="d-flex align-items-center justify-content-end flex-wrap flex-sm-nowrap mt-5">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-light btn-lg w-80px mr-2 font-weight-bold btn-shadow-hover rounded bg-white">취소</button>
                                            <button type="button" class="btn btn-primary btn-lg w-80px font-weight-bold btn-shadow-hover rounded mr-2" name="submitButton" id="interSave">저장</button>
                                        </div>
                                    </div>
                                    <!-- end::버튼 그룹 -->
                                </div>
