...
<!--begin::Aside-->
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<!--begin::Brand-->
					<div class="brand flex-column-auto py-12" id="kt_brand">

						<!--begin::Logo-->
						<a href="login.php" class="brand-logo m-auto">
							<img alt="Logo-l" src="./assets/media/logos/logo-pc.svg" class="h-30px lg-mode" />
							<img alt="Logo-m" src="./assets/media/logos/logo-m.svg" class="h-30px sm-mode"/>
						</a>
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav pt-0">
								...
								<li class="menu-section mt-0">
									<h4 class="menu-text">수업</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<!-- <li class="menu-item menu-item-active" aria-haspopup="true" data-menu-toggle="hover"> -->
								<li class="menu-item 
								<?php echo strpos($_GET['cms'], 'lesson/main') ? 'menu-item-active' : '';  ?>
								" aria-haspopup="true" data-menu-toggle="hover">
								
									<a href="?cms=/lesson/main" class="menu-link">
									<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-18-122719/theme/demo1/dist/../src/media/svg/icons/Files/Upload-folder.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										...
										<span class="menu-text">콘텐츠 등록</span>
									</a>
								</li>
								<!-- <li class="menu-item" aria-haspopup="true" data-menu-toggle="hover"> -->
								<li class="menu-item
								<?php echo strpos($_GET['cms'], 'interaction') ? 'menu-item-active' : '';  ?>
								" aria-haspopup="true" data-menu-toggle="hover">
									<a href="?cms=/lesson/interaction" class="menu-link">
										...
										<span class="menu-text">인터랙션 추가</span>
									</a>
								</li>
								<li class="menu-item
								<?php echo strpos($_GET['cms'], 'publish') ? 'menu-item-active' : '';  ?>
								" aria-haspopup="true" data-menu-toggle="hover">
									<a href="?cms=/lesson/publish/edit/e1" class="menu-link">
									    <span class="svg-icon menu-icon">
										...
										<span class="menu-text">배포하기</span>
									</a>
								</li>
								<!-- //수업 -->
								<!-- 연구실 -->
								<li class="menu-section">
									<h4 class="menu-text">연구실</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									<a href="javascript:;" class="menu-link menu-toggle">
										...
										<span class="menu-text">강의관리</span>
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item
											<?php echo strpos($_GET['cms'], 'lab/main') ? 'menu-item-active' : '';  ?>
											" aria-haspopup="true">
												<a href="?cms=/lab/main" class="menu-link">
												<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-18-122719/theme/demo1/dist/../src/media/svg/icons/Files/Group-folders.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M2.5,19 L19.5,19 C20.3284271,19 21,18.3284271 21,17.5 L21,6.5 C21,5.67157288 20.3284271,5 19.5,5 L9,5 L6.43933983,2.43933983 C6.15803526,2.15803526 5.77650439,2 5.37867966,2 L2.5,2 C1.67157288,2 1,2.67157288 1,3.5 L1,17.5 C1,18.3284271 1.67157288,19 2.5,19 Z" fill="#000000"/>
								...
								<li class="menu-item
								<?php echo strpos($_GET['cms'], 'lab/class') ? 'menu-item-active' : '';  ?>"
								 aria-haspopup="true" data-menu-toggle="hover">
									<a href="?cms=/lab/class" class="menu-link">
									<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-18-122719/theme/demo1/dist/../src/media/svg/icons/Files/User-folder.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
												<rect x="0" y="0" width="24" height="24"/>
												<path d="M3.5,21 L20.5,21 C21.3284271,21 22,20.3284271 22,19.5 L22,8.5 C22,7.67157288 21.3284271,7 20.5,7 L10,7 L7.43933983,4.43933983 C7.15803526,4.15803526 6.77650439,4 6.37867966,4 L3.5,4 C2.67157288,4 2,4.67157288 2,5.5 L2,19.5 C2,20.3284271 2.67157288,21 3.5,21 Z" fill="#000000" opacity="0.3"/>
										...
										<span class="menu-text">학생관리</span>
									</a>
								</li>
								<li class="menu-item 
								<?php echo strpos($_GET['cms'], 'lab/analysis') ? 'menu-item-active' : '';  ?>"
								 aria-haspopup="true" data-menu-toggle="hover">
									<a href="?cms=/lab/analysis" class="menu-link">
									    <span class="svg-icon menu-icon">
										...
										<span class="menu-text">학생분석</span>
									</a>
								</li>
								<!-- //연구실 -->
								<!-- 나눔공간 -->
								<li class="menu-section">
									<h4 class="menu-text">나눔공간</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
								<li class="menu-item 
								<?php echo strpos($_GET['cms'], 'share/class-share') ? 'menu-item-active' : '';  ?>
								" aria-haspopup="true" data-menu-toggle="hover">
									<a href="?cms=/share/class-share" class="menu-link">
									    <span class="svg-icon menu-icon">
										 <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-18-122719/theme/demo1/dist/../src/media/svg/icons/Communication/Share.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"/>
										...
										<span class="menu-text">강의나눔</span>
									</a>
								</li>
								<li class="menu-item
								<?php echo strpos($_GET['cms'], 'share/data-share') ? 'menu-item-active' : '';  ?>
								" aria-haspopup="true" data-menu-toggle="hover">
									<a href="?cms=/share/data-share" class="menu-link">
									<span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/keen/releases/2021-04-18-122719/theme/demo1/dist/../src/media/svg/icons/Files/Compiled-file.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">자료나눔</span>
									</a>
								</li>
								<!-- //나눔공간 -->
							</ul>
