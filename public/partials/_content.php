                        ...
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap w-100">
                                ...
                                <div class="d-flex align-items-baseline flex-wrap justify-content-between w-100">
                                    <!--begin::Page Title-->
                                    <h5 class="text-dark font-weight-bold my-1 mr-5">강의나눔 </h5>
                                    <!--end::Page Title-->
                                    <!--begin::Breadcrumb-->
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        <li class="breadcrumb-item text-muted">
                                            <a href="" class="text-muted">나눔공간</a>
                                        </li>
                                        <li class="breadcrumb-item text-muted">
                                            <a href="" class="text-muted">강의나눔</a>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                                <!--end::Page Heading-->
                                <p>선생님들이 직접 저작한 강의를 자유롭게 활용할 수 있도록
                                    함께 나누는 공간입니다</p>
                            </div>
                            <!--end::Info-->
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body">
                                            <div id="stats-widget-slider-1" class="carousel slide" data-ride="carousel" data-interval="8000">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <!--begin::Label-->
                                                    <span class="font-size-h6 text-muted font-weight-bolder text-uppercase pr-2">알림</span>
                                                    <!--end::Label-->
                                                    <!--begin::Action-->
                                                    <div class="p-0">
                                                        <a href="#stats-widget-slider-1" class="btn btn-icon btn-light btn-sm mr-1" role="button" data-slide="prev">
                                                            <span class="svg-icon svg-icon-md">
                                                                <!--begin::Svg Icon | path:/keen/theme/demo5/dist/assets/media/svg/icons/Navigation/Angle-left.svg-->
                                        ...
                                        <div class="card-footer border-0 d-flex align-items-center justify-content-between pt-0">
                                            ...
                                            <span class="label label-lg label-light-primary label-inline font-size-sm font-weight-bolder py-5">03
                                                SEP, 20</span>
                                            <!--end::Label-->
                                            <a href="#none" class="btn btn-sm btn-primary font-weight-bolder px-6">Join</a>
                                        </div>
                                        <!--end::Footer-->
                                    </div>
                                    <!--end::Stats Widget 10-->
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body">
                                            <div id="stats-widget-slider-2" class="carousel slide" data-ride="carousel" data-interval="8000">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <!--begin::Label-->
                                                    <span class="font-size-h6 text-muted font-weight-bolder text-uppercase pr-2">프로젝트</span>
                                                    <!--end::Label-->
                                                    <!--begin::Action-->
                                                    <div class="p-0">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-body">
                                            <div id="stats-widget-slider-3" class="carousel slide" data-ride="carousel" data-interval="8000">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    <!--begin::Label-->
                                                    <span class="font-size-h6 text-muted font-weight-bolder text-uppercase pr-2">오늘
                                                        일정</span>
                                                    <!--end::Label-->
                                                    <!--begin::Action-->
                                                    <div class="p-0">
                                                ...
                                                <div class="carousel-inner pt-9">
                                                    ...
                                                    <div class="carousel-item">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <!--end::Title-->
                                                            <!--begin::Text-->
                                                            <p class="text-primary font-size-h2 font-weight-bold pt-3 mb-0">
                                                                11:15AM - 12:30PM</p>
                                                            <!--end::Text-->
                                                        </div>
                                                        <!--end::Section-->
                            ...
                            <div class="row">
                                <div class="col-xxl-4">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="carousel-item active">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <p class="text-dark-75 font-size-lg font-weight-normal pt-2">
                                                                To
                                                                start a blog, think of a topic about and first
                                                                brainstorm
                                                                ways to write details</p>
                                                            <!--end::Text-->
                                                        </div>
                                                        ...
                                                        <div class="d-flex pt-9">
                                                            ...
                                                            <div class="bg-light rounded w-90px h-60px d-flex flex-center flex-column mr-3">
                                                                <span class="font-size-sm font-weight-bold text-muted pb-1">Due
                                                                    Date</span>
                                                                <span class="font-size-sm font-weight-bolder text-dark-75">Apr
                                                                    11, 20</span>
                                                            </div>
                                                            <!--end::Info-->
                                                            <!--begin::Info-->
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between py-5">
                                            ...
                                            <a href="#none" class="btn btn-sm btn-primary font-weight-bolder">Join</a>
                                        </div>
                                        <!--end::Footer-->
                                    </div>
                                    <!--end::Mixed Widget 7-->
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-6">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder font-size-h4 text-dark-75">인기검색어</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-lg">Avarage
                                                    +47%</span>
                                            </h3>
                                            <div class="card-toolbar">
                                                <div class="dropdown dropdown-inline">
                                                    <a href="#none" class="btn btn-icon-primary btn-clean btn-hover-light-primary btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <span class="svg-icon svg-icon-lg">
                                                            <!--begin::Svg Icon | path:/keen/theme/demo5/dist/assets/media/svg/icons/Text/Dots.svg-->
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        ...
                                                        <ul class="navi navi-hover py-5">
                                                            ...
                                                            <li class="navi-item">
                                                                <a href="#none" class="navi-link">
                                                                    ...
                                                                    <span class="navi-text">요금정책</span>
                                                                </a>
                                                            </li>
                                                            <li class="navi-item">
                                                                <a href="#none" class="navi-link">
                                        ...
                                        <div class="card-body d-flex flex-column pb-20">
                                            ...
                                            <div class="flex-grow-1 pb-5">
                                                ...
                                                <div class="d-flex align-items-center mb-6">
                                                    <!--begin::Symbol-->
                                                    <div class="symbol symbol-35 flex-shrink-0 mr-3">
                                                        <img alt="Pic" src="../assets/img/014-girl-7.svg">
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Content-->
                                                    <div class="d-flex flex-wrap flex-row-fluid">
                                                        ...
                                                        <div class="d-flex flex-column pr-5 flex-grow-1">
                                                            <a href="#none" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">Marcus
                                                                Smart</a>
                                                        ...
                                                        <div class="d-flex align-items-center py-2">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Btn-->
                                                            <a href="#none" class="btn btn-icon btn-light btn-sm">
                                                ...
                                                <div class="d-flex align-items-center mb-6">
                                                    ...
                                                    <div class="d-flex flex-wrap flex-row-fluid">
                                                        <!--begin::Text-->
                                                        <div class="d-flex flex-column pr-5 flex-grow-1">
                                                            <a href="#none" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">Andreas
                                                                Hawks</a>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-wrap flex-row-fluid">
                                                        <!--begin::Text-->
                                                        <div class="d-flex flex-column pr-5 flex-grow-1">
                                                            <a href="#none" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">Sarah
                                                                Connor</a>
                                            ...
                                            <div class="progress-vertical min-h-150px flex-grow-1 border-bottom">
                                                <div class="text-center mr-1">
                                                    <div class="progress bg-light-primary mb-4 mr-0 rounded-bottom-0" data-toggle="tooltip" title="" data-original-title="40%">
                                                ...
                                                <div class="text-center mx-1">
                                                    <div class="progress bg-light-primary mb-4 mr-0 rounded-bottom-0" data-toggle="tooltip" title="" data-original-title="65%">
                                                ...
                                                <div class="text-center mx-1">
                                                    <div class="progress bg-light-primary mb-4 mr-0 rounded-bottom-0" data-toggle="tooltip" title="" data-original-title="50%">
                                                ...
                                                <div class="text-center ml-1">
                                                    <div class="progress bg-light-primary mb-4 mr-0 rounded-bottom-0" data-toggle="tooltip" title="" data-original-title="80%">
                                ...
                                <div class="col-xxl-4">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-6">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder font-size-h4 text-dark-75">학습현황</span>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="pt-10">
                                                ...
                                                <div class="flex-row-fluid">
                                                    <span class="text-dark-75 font-weight-bold display4">7,852
                                                        <span class="text-muted font-size-h5 font-weight-bold pl-2">Total
                                                            Orders</span></span>
                                                ...
                                                <div class="pt-13">
                                                    ...
                                                    <div class="d-flex align-items-center pb-8">
                                                        ...
                                                        <div class="d-flex align-items-center flex-wrap flex-row-fluid">
                                                            ...
                                                            <div class="d-flex flex-column flex-grow-1 pr-5">
                                                                <a href="#none" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">Mobile
                                                                    Games</a>
                                                                <span class="text-muted font-weight-bold">Swift, Python,
                                                                    Java SDK</span>
                                                            </div>
                                                            <!--end::Text-->
                                                            <!--begin::Label-->
                                                    ...
                                                    <div class="d-flex align-items-center pb-8">
                                                        ...
                                                        <div class="d-flex align-items-center flex-wrap flex-row-fluid">
                                                            <!--begin::Text-->
                                                            <div class="d-flex flex-column flex-grow-1 pr-5">
                                                                <a href="#none" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">B2B2C
                                                                    Solutionss</a>
                                                                <span class="text-muted font-weight-bold">ASP.NET, Ruby,
                                                                    Python</span>
                                                            </div>
                                                            <!--end::Text-->
                                                            <!--begin::Label-->
                                                    ...
                                                    <div class="d-flex align-items-center pb-8">
                                                        ...
                                                        <div class="d-flex align-items-center flex-wrap flex-row-fluid">
                                                            <!--begin::Text-->
                                                            <div class="d-flex flex-column flex-grow-1 pr-5">
                                                                <a href="#none" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">HTML
                                                                    Templates</a>
                                                                <span class="text-muted font-weight-bold">HTML, CSS,
                                                                    JS</span>
                                                            </div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex align-items-center flex-wrap flex-row-fluid">
                                                            <!--begin::Text-->
                                                            <div class="d-flex flex-column flex-grow-1 pr-5">
                                                                <a href="#none" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">Back-end
                                                                    Plugins</a>
                                                                <span class="text-muted font-weight-bold">PHP, Ruby, C#,
                                                                    ASP.NET</span>
                                                            </div>
                                                            <!--end::Text-->
                                                            <!--begin::Label-->
                            ...
                            <div class="row">
                                <div class="col-xxl-4">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-6">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder font-size-h4 text-dark-75">우수학생</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-lg">240,000
                                                    Total
                                                    Sales</span>
                                            </h3>
                                        ...
                                        <div class="card-body pt-5">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-2">
                                                ...
                                                <div class="symbol symbol-60 symbol-white">
                                                    <span class="symbol-label d-flex justify-content-start w-45px ml-n1">
                                                        <img src="./assets/media/users/blank.png" class="h-50 align-self-center" alt="">
                                                    </span>
                                                </div>
                                                <!--end::Icon-->
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
                                                    <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">BP
                                                        Industries</a>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-2">
                                                ...
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
                                                    <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Automatica</a>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-2">
                                                ...
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
                                                    <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Pythpn
                                                        Inc.</a>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center pb-2">
                                                ...
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
                                                    <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">인기
                                                        유튜브 컨텐츠</a>
                                            ...
                                            <div class="d-flex flex-wrap align-items-center">
                                                ...
                                                <!--begin::Title-->
                                                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 mr-2">
                                                    <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Sass
                                                        Tech.</a>
                                ...
                                <div class="col-xxl-4">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header align-items-center border-0 mt-4">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="font-weight-bolder text-dark">최근 활동</span>
                                                <span class="text-muted mt-3 font-weight-bold font-size-sm">445,634
                                                    Sales</span>
                                            </h3>
                                            <div class="card-toolbar">
                                                <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="card-body pt-4">
                                            ...
                                            <div class="timeline timeline-6 mt-3">
                                                ...
                                                <div class="timeline-item align-items-start">
                                                    <!--begin::Label-->
                                                    <div class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-4">
                                                        03:34</div>
                                                    <!--end::Label-->
                                                    <!--begin::Badge-->
                                                    ...
                                                    <!--end::Badge-->
                                                    <!--begin::Text-->
                                                    <div class="timeline-content text-dark-50 pl-2">Outlines of the
                                                        recent
                                                        activities that happened last weekend</div>
                                                    <!--end::Text-->
                                                </div>
                                                <!--end::Item-->
                                                <!--begin::Item-->
                                                <div class="timeline-item align-items-start">
                                                    ...
                                                    <div class="timeline-content d-flex">
                                                        <span class="mr-4 font-weight-bolder text-dark-75 pl-2">AEOL
                                                            meeting
                                                            with</span>
                                                        <!--begin::Section-->
                                                        <div class="d-flex align-items-start mt-n2">
                                                            <!--begin::Symbol-->
                                                            <a href="#none" class="symbol symbol-35 symbol-light-success mr-2">
                                                            ...
                                                            <!--end::Symbol-->
                                                            <!--begin::Symbol-->
                                                            <a href="#none" class="symbol symbol-35 symbol-light-success">
                                                                <span class="symbol-label">
                                                                    <img src="./assets/media/users/blank.png" class="h-50 align-self-center" alt="">
                                                                </span>
                                                            </a>
                                                ...
                                                <div class="timeline-item align-items-start">
                                                    ...
                                                    <!--end::Badge-->
                                                    <!--begin::Desc-->
                                                    <div class="timeline-content font-weight-bolder text-dark-75 pl-2">
                                                        Submit initial budget -
                                                        <a href="#none" class="text-primary">USD 300</a>.
                                                    </div>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Item-->
                                                ...
                                                <div class="timeline-item align-items-start">
                                                    ...
                                                    <!--end::Badge-->
                                                    <!--begin::Text-->
                                                    <div class="timeline-content text-dark-50 pl-2">Stakeholder meeting
                                                        scheduling.</div>
                                                    <!--end::Text-->
                                                </div>
                                                <!--end::Item-->
                                                ...
                                                <div class="timeline-item align-items-start">
                                                    ...
                                                    <!--end::Badge-->
                                                    <!--begin::Text-->
                                                    <div class="timeline-content text-dark-50 pl-2">Project scoping
                                                        &amp;
                                                        estimations with stakeholders.</div>
                                                    <!--end::Text-->
                                                </div>
                                                <!--end::Item-->
                                                <!--begin::Item-->
                                                <div class="timeline-item align-items-start">
                                                    ...
                                                    <div class="timeline-content font-weight-bolder text-dark-75 pl-2">
                                                        New
                                                        order placed
                                                        <a href="#none" class="text-primary">#XF-4356</a>.
                                                    </div>
                                                    <!--end::Desc-->
                                                </div>
                                                <!--end::Item-->
                                                ...
                                                <div class="timeline-item align-items-start">
                                                    ...
                                                    <!--end::Badge-->
                                                    <!--begin::Text-->
                                                    <div class="timeline-content text-dark-50 pl-2">Company BBQ to
                                                        celebrate
                                                        the last quater achievements and goals.</div>
                                                    <!--end::Text-->
                                                </div>
                                                <!--end: Item-->
                                            </div>
                                ...
                                <div class="col-xxl-4">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-7">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder font-size-h4 text-dark-75">인기
                                                    유튜브 컨텐츠</span>
                                            ...
                                            <div class="tab-content mt-5" id="myTabList3">
                                                ...
                                                <div class="tab-pane fade" id="kt_tab_list_3_1" role="tabpanel" aria-labelledby="kt_tab_list_3_1">
                                                    ...
                                                    <div class="d-flex align-items-center mb-7">
                                                        <!--begin::Btn-->
                                                        <a href="#none" class="btn btn-icon btn-light-primary font-weight-bold btn-md mr-3">
                                                            <span class="svg-icon svg-icon-xxl">
                                                                <!--begin::Svg Icon | path:/keen/theme/demo5/dist/assets/media/svg/icons/Media/Play.svg-->
                                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                        <rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <a href="#none" class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">AirTicks
                                                                Meeting</a>
                                                        ...
                                                        <div class="dropdown dropdown-inline ml-2">
                                                            <a href="#none" class="btn btn-icon-primary btn-hover-light-primary btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            ...
                                                            <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
                                                                ...
                                                                <ul class="navi navi-hover">
                                                                    ...
                                                                    <li class="navi-footer py-4">
                                                                        <a class="btn btn-primary font-weight-bold btn-sm px-5" href="#none">
                                                    ...
                                                    <div class="d-flex align-items-center mb-7">
                                                        ...
                                                        <!--begin::Text-->
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <a href="#none" class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">From
                                                                a Distance</a>
                                                    ...
                                                    <div class="d-flex align-items-center mb-7">
                                                        ...
                                                        <!--begin::Text-->
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <a href="#none" class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">Space
                                                                Weawer</a>
                                                    ...
                                                    <div class="d-flex align-items-center mb-7">
                                                        ...
                                                        <!--begin::Text-->
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <a href="#none" class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">Sunspots</a>
                                                    ...
                                                    <div class="d-flex align-items-center mb-7">
                                                        ...
                                                        <!--begin::Text-->
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <a href="#none" class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">Ocean
                                                                Drive</a>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <!--begin::Text-->
                                                        <div class="d-flex flex-column flex-grow-1">
                                                            <a href="#none" class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">Soar,
                                                                Eco</a>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            ...
                                            <div class="card-toolbar">
                                                <div class="dropdown dropdown-inline">
                                                    <a href="#none" class="btn btn-clean btn-sm btn-icon" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="pt-5">
                                                ...
                                                <a href="#none" class="btn btn-success btn-shadow-hover font-weight-bolder w-100 py-3">Generate
                                                    Report</a>
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="card card-custom card-stretch gutter-b">
                                        ...
                                        <div class="card-header border-0 py-5">
                                            ...
                                            <div class="card-toolbar">
                                                <a href="#none" class="btn btn-info font-weight-bolder font-size-sm mr-3">New
                                                    Report</a>
                                                <a href="#none" class="btn btn-danger font-weight-bolder font-size-sm">Create</a>
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                                    ...
                                                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="pl-0 py-8">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50 symbol-light mr-4">
                                                                            <span class="symbol-label">
                                                                                <img src="./assets/media/014-girl-7.svg" class="h-75 align-self-end" alt="">
                                                                            </span>
                                                                        </div>
                                                                        <div>
                                                                            <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Brad
                                                                                Simmons</a>
                                                                ...
                                                                <td>
                                                                    <img src="./assets/media/stars.png" alt="image" style="width: 5.5rem">
                                                                    <span class="text-muted font-weight-bold d-block font-size-sm">Best
                                                                        Rated</span>
                                                                </td>
                                                                <td class="p-0 text-right">
                                                                    <a href="#none" class="btn btn-light-success font-weight-bolder font-size-sm">의견보기</a>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="pl-0 py-0">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50 symbol-light mr-4">
                                                                            <span class="symbol-label">
                                                                                <img src="./assets/media/svg/018-girl-9.svg" class="h-75 align-self-end" alt="">
                                                                            </span>
                                                                        </div>
                                                                        <div>
                                                                            <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Jessie
                                                                                Clarcson</a>
                                                            ...
                                                            <tr>
                                                                <td class="pl-0 py-8">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Lebron
                                                                                Wayde</a>
                                                            ...
                                                            <tr>
                                                                <td class="pl-0 py-0">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <a href="#none" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">Natali
                                                                                Trump</a>
                                                                ...
                                                                <td>
                                                                    <img src="./assets/media/stars.png" style="width: 5.5rem" alt="">
                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header border-0 pt-7">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label font-weight-bolder font-size-h4 text-dark-75">학생리스트</span>
                                ...
                                <div class="card-body pt-0 pb-4">
                                    <div class="tab-content mt-2" id="myTabTable5">
                                        <!--begin::Tap pane-->
                                        <div class="tab-pane fade show active" id="kt_tab_table_5_1" role="tabpanel" aria-labelledby="kt_tab_table_5_1">
                                            <!--begin::Table-->
                                            <div class="table-responsive">
                                                <table class="table table-borderless table-vertical-center">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Telegram
                                                                    Mobile Application Development</a>
                                                                <div>
                                                                    <span class="font-weight-bolder text-dark-75">FTP:</span>
                                                                    <a class="text-muted font-weight-bold text-hover-primary" href="#none">bprow@bnc.cc</a>
                                                                </div>
                                                            </td>
                                                            <td class="text-right">
                                                            ...
                                                            <td class="text-right pr-0">
                                                                <a href="#none" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                                                    <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                ...
                                                                <a href="#none" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                                                    <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                ...
                                                                <a href="#none" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                                                    <span class="svg-icon svg-icon-md svg-icon-primary">
                                                                        <!--begin::Svg Icon | path:/keen/theme/demo5/dist/assets/media/svg/icons/General/Trash.svg-->
                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                <rect x="0" y="0" width="24" height="24">
                                                                                </rect>
                                                        ...
                                                        <tr>
                                                            <td class="pl-0">
                                                                <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Cisco
                                                                    Management Payrol Application</a>
                                                                <div>
                                                                    <span class="font-weight-bolder text-dark-75">FTP:</span>
                                                                    <a class="text-muted font-weight-bold text-hover-primary" href="#none">bprow@bnc.cc</a>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Beats
                                                                    Studio HR Management System</a>
                                                                <div>
                                                                    <span class="font-weight-bolder text-dark-75">FTP:</span>
                                                                    <a class="text-muted font-weight-bold text-hover-primary" href="#none">bprow@bnc.cc</a>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pl-0 ml-n3">
                                                                <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Sant
                                                                    Outstanding Extreanet Solution</a>
                                                                <div>
                                                                    <span class="font-weight-bolder text-dark-75">FTP:</span>
                                                                    <a class="text-muted font-weight-bold text-hover-primary" href="#none">bprow@bnc.cc</a>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pl-0">
                                                                <a href="#none" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">KTR
